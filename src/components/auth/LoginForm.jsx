    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-blue-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">EduQuiz <span className="text-blue-200 font-normal">Admin</span></h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-lg border border-slate-200 text-slate-800 text-sm placeholder-slate-400
